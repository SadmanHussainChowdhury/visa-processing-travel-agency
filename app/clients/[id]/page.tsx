...
export default function ClientViewPage() {
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      ...
      try {
        ...
        if (response.ok) {
          const data = await response.json();
          // Filter appointments for this client by clientId or clientName
          const clientAppointments = data.filter((apt: any) => 
            apt.clientId === params.id || 
            apt.clientId === client._id ||
            apt.clientName?.toLowerCase() === `${client.firstName} ${client.lastName}`.toLowerCase()
          );
  ...
  // Fetch AI results for this client
  const fetchAIResults = async () => {
    ...
    try {
      ...
      const debugResponse = await fetch(`/api/ai-results/debug?clientId=${patientId}`);
      if (debugResponse.ok) {
      ...
      // Then fetch normally
      const response = await fetch(`/api/ai-results?clientId=${patientId}`);
      if (response.ok) {
        const data = await response.json();
        ...
        <div className="max-w-7xl mx-auto">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900">{client.bloodType || 'Not specified'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900">{client.assignedOfficer || 'Not assigned'}</p>
                    </div>
                  </div>
          ...
          {client.medicalHistory && (
                    <div>
                      ...
                      <p className="text-sm text-gray-900">{client.medicalHistory}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                {loadingAppointments ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="mt-2 text-sm text-gray-500">No appointments found for this client</p>
                  </div>
                ) : (
              ...
              <div className="p-6">
                ...
                {loadingAiResults ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="mt-2 text-sm text-gray-500">No treatment plans available for this client</p>
                  </div>
                ) : (
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
              ...
              <div className="p-6">
                ...
                {loadingAiResults ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="mt-2 text-sm text-gray-500">No prescriptions available for this client</p>
                  </div>
                ) : (
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                  ...
                  return (
                    <>
                      ...
                      {loadingAiResults ? (
                        ...
                        <div className="text-center py-8">
                          <Brain className="mx-auto h-12 w-12 text-gray-400" />
                          <p className="mt-2 text-sm text-gray-500">No {getTypeLabel().toLowerCase()} available for this client</p>
                        </div>
                      ) : (
                        <div className="overflow-x-auto">
                          <table className="min-w-full divide-y divide-gray-200">
