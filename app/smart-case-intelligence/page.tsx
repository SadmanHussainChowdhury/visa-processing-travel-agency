...
export default function SmartCaseIntelligencePage() {
  ...
  const filteredCases = cases.filter(caseItem => {
    const matchesSearch = 
      caseItem.caseId.toLowerCase().includes(filters.searchQuery.toLowerCase()) ||
      caseItem.clientName.toLowerCase().includes(filters.searchQuery.toLowerCase()) ||
      caseItem.visaType.toLowerCase().includes(filters.searchQuery.toLowerCase()) ||
      caseItem.country.toLowerCase().includes(filters.searchQuery.toLowerCase());
    
    const matchesRiskLevel = !filters.riskLevel || caseItem.riskLevel === filters.riskLevel;
    const matchesPriority = !filters.priority || caseItem.priority === filters.priority;
    const matchesVisaType = !filters.visaType || caseItem.visaType === filters.visaType;
    const matchesCountry = !filters.country || caseItem.country === filters.country;
    
    return matchesSearch && matchesRiskLevel && matchesPriority && matchesVisaType && matchesCountry;
  });
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {Math.round(filteredCases.reduce((sum, c) => sum + c.successProbability, 0) / filteredCases.length)}%
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {filteredCases.filter(c => c.riskLevel === 'high' || c.riskLevel === 'critical').length}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {filteredCases.filter(c => c.duplicateDetected).length}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {filteredCases.filter(c => c.priority === 'express').length}
              </p>
            </div>
          </div>
        </div>
