...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if ((status as string) !== 'loading' && (status as string) !== 'authenticated') {
      router.push('/login');
    }
  }, [status, router]);
  ...
  return (
    <ProtectedRoute>
      <SidebarLayout 
        ...
        description="Welcome to your AI-powered visa processing travel agency dashboard"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {isLoading ? (
              ...
              stats.map((stat) => {
                ...
                let href = '#';
                switch (stat.name) {
                  case t('dashboard.stats.totalClients'):
                    href = '/clients';
                    break;
