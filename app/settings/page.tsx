...
export default function SettingsPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setMessage({ type: 'success', text: t('ai.settings.saved') });
    } catch (error) {
      setMessage({ type: 'error', text: t('ai.settings.error') });
    } finally {
      setSaving(false);
    }
  };
  ...
  const handleReset = () => {
    if (confirm(t('ai.settings.confirmReset'))) {
  ...
  if (loading) {
    return (
      <ProtectedRoute>
        <SidebarLayout title={t('ai.settings.title')} description={t('ai.settings.description')}>
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="mb-6">
            ...
            >
              ...
              <span>{t('ai.settings.backToDashboard')}</span>
            </Link>
          </div>
              ...
              <div className="p-6">
                ...
                <nav className="space-y-2">
                  ...
                  >
                    ...
                    <span>{t('ai.settings.general.title')}</span>
                  </button>
                  ...
                  >
                    ...
                    <span>{t('ai.settings.appearance')}</span>
                  </button>
                  ...
                  >
                    ...
                    <span>{t('ai.settings.notifications')}</span>
                  </button>
                  ...
                  >
                    ...
                    <span>{t('ai.settings.workingHours')}</span>
                  </button>
                  ...
                  >
                    ...
                    <span>{t('ai.settings.contact')}</span>
                  </button>
                </nav>
              </div>
            </div>
            ...
            <div className="flex-1 p-6">
              <form onSubmit={(e) => { e.preventDefault(); handleSave(); }}>
                ...
                {activeTab === 'general' && (
                  <div>
                    <div className="mb-6">
                      <h3 className="text-xl font-semibold text-gray-900">{t('ai.settings.general.title')}</h3>
              ...
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">{t('ai.settings.general.title')}</h3>
                  <p className="text-sm text-gray-600">Basic system configuration</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="systemTitle" className="block text-sm font-medium text-gray-700 mb-1">
                    {t('ai.settings.general.systemTitle')}
                  </label>
                  <input
                    type="text"
                    id="systemTitle"
                ...
                <div>
                  <label htmlFor="currency" className="block text-sm font-medium text-gray-700 mb-1">
                    {t('ai.settings.general.currency')}
                  </label>
                  <select
                    id="currency"
                    name="currency"
                ...
                <div>
                  <label htmlFor="timezone" className="block text-sm font-medium text-gray-700 mb-1">
                    {t('ai.settings.general.timezone')}
                  </label>
                  <select
                    id="timezone"
                    name="timezone"
                ...
                <div>
                  <label htmlFor="maxAppointmentsPerDay" className="block text-sm font-medium text-gray-700 mb-1">
                    {t('ai.settings.maxAppointmentsPerDay')}
                  </label>
                  <input
                    type="number"
                  ...
                  />
                    ...
                    <div className="mt-6">
                      <label htmlFor="systemDescription" className="block text-sm font-medium text-gray-700 mb-1">
                        {t('ai.settings.general.systemDescription')}
                      </label>
                      <textarea
                ...
                {activeTab === 'appearance' && (
                  <div>
                    <div className="mb-6">
                      <h3 className="text-xl font-semibold text-gray-900">{t('ai.settings.appearance')}</h3>
                ...
                {activeTab === 'notifications' && (
                  <div>
                    <div className="mb-6">
                      <h3 className="text-xl font-semibold text-gray-900">{t('ai.settings.notifications')}</h3>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <label htmlFor="emailNotifications" className="text-sm font-medium text-gray-700">
                            {t('ai.settings.emailNotifications')}
                          </label>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <label htmlFor="smsNotifications" className="text-sm font-medium text-gray-700">
                            {t('ai.settings.smsNotifications')}
                          </label>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <label htmlFor="appointmentReminders" className="text-sm font-medium text-gray-700">
                            {t('ai.settings.appointmentReminders')}
                          </label>
                ...
                {activeTab === 'working-hours' && (
                  <div>
                    <div className="mb-6">
                      <h3 className="text-xl font-semibold text-gray-900">{t('ai.settings.workingHours')}</h3>
                ...
                {activeTab === 'contact' && (
                  <div>
                    <div className="mb-6">
                      <h3 className="text-xl font-semibold text-gray-900">{t('ai.settings.contact')}</h3>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200 flex items-center justify-between">
                ...
                >
                  ...
                  <span>{saving ? t('ai.settings.saving') : t('ai.settings.save')}</span>
                </button>
              </div>
            </div>
          </div>
